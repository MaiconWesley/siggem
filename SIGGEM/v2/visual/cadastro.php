              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-12 text-center">
                    ...
                    <a href="login.php" title="Voltar"><i class="fa fa-3x fa-fw fa-reply"></i></a>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form class="form-horizontal text-left" role="form" method="POST">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" placeholder="Como se chama?">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-10 col-sm-offset-2 text-right">
                          <button type="submit" class="btn btn-lg btn-success" name="btn_acao" value="login">Cadastrar</button>
                        </div>
                  ...
                  <h5 class="hidden-sm hidden-xs text-center text-primary">2016 ©
                    <a href="https://fb.com/maiconwesley">MWMS</a>
                  </h5>
