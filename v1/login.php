            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2 class="text-center text-info">Entre com suas Credenciais
                            <br>
                        </h2>
                        <?php
                            session_start();
                        ...
                        <div class="container">
                                    ...
                                    <form class="form-horizontal" role="form" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10 col-md-1">
                                                <button type="submit" class="btn btn-info" name="btn_acao" value="login">Acessar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h5 class="text-center text-danger">Esqueceu sua Senha ? &nbsp; &nbsp; &nbsp;
